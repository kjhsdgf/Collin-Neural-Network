...
/*
 *
 * dfftw_plan_guru_dft_r2c - FFTW3 Fortran 77 wrapper to Intel(R) MKL.
 *
 ******************************************************************************
 */
                        ...
                        COMPLEX16 *out, INTEGER *flags)
{
    ...
    *(fftw_plan *)p =
        fftw_plan_guru64_dft_r2c(*rank, dims64, *howmany_rank, howmany_dims64,
                                 in, out, *flags);
}
