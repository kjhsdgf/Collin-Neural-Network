...
/*
 *
 * fftw_plan_many_dft_r2c - FFTW3 wrapper to Intel(R) MKL.
 *
 ******************************************************************************
 */
...
fftw_plan
fftw_plan_many_dft_r2c(int rank, const int *n, int howmany, double *in,
                       ...
                       int odist, unsigned flags)
{
    ...
    return fftw_plan_guru64_dft_r2c(rank, dims64, 1, &howmany64, in, out,
                                    flags);
}
