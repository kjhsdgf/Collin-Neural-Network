...
/*
 *
 * dfftw_plan_many_r2r - FFTW3 Fortran 77 wrapper to Intel(R) MKL.
 *
 ******************************************************************************
 */
...
void
dfftw_plan_many_r2r(PLAN *p, INTEGER *rank, INTEGER *n, INTEGER *howmany,
                    ...
                    INTEGER *flags)
{
    ...
    dfftw_plan_guru_r2r(p, rank, n, is, os, &one, howmany, idist, odist, in,
                        out, kind, flags);
}
