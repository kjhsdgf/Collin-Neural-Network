...
/*
 *
 * fftw_plan_guru_dft_r2c - FFTW3 wrapper to Intel(R) MKL.
 *
 ******************************************************************************
 */
...
fftw_plan
fftw_plan_guru_dft_r2c(int rank, const fftw_iodim *dims, int howmany_rank,
                       ...
                       fftw_complex *out, unsigned flags)
{
    ...
    return fftw_plan_guru64_dft_r2c(rank, dims64, howmany_rank, howmany_dims64,
                                    in, out, flags);
}
