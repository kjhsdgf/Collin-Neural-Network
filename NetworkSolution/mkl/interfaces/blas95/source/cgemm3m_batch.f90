...
PURE SUBROUTINE CGEMM3M_BATCH_F95(A_ARRAY,B_ARRAY,C_ARRAY,M_ARRAY,      &
     &                          N_ARRAY,K_ARRAY,GROUP_SIZE,TRANSA_ARRAY,&
     &                          TRANSB_ARRAY,ALPHA_ARRAY,BETA_ARRAY)
    ! Fortran77 call:
    ! CGEMM3M_BATCH(TRANSA_ARRAY,TRANSB_ARRAY,M_ARRAY,N_ARRAY,K_ARRAY,
    ...
    ! <<< Local declarations >>>
    ! <<< Parameters >>>
    CHARACTER(LEN=13), PARAMETER :: SRNAME = 'CGEMM3M_BATCH'
    ! <<< Local scalars >>>
