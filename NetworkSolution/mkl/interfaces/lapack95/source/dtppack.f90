...
PURE SUBROUTINE MKL_DTPPACK_F95(AP,I,J,ROWS,COLS,A,UPLO,TRANS,INFO)
    ...
    ! <<< Use statements >>>
    USE F77_LAPACK, ONLY: F77_MKL_TPPACK, F77_XERBLA
    ! <<< Implicit statement >>>
    IMPLICIT NONE
    ! <<< Kind parameter >>>
    ...
    ! <<< Local declarations >>>
    ! <<< Parameters >>>
    CHARACTER(LEN=12), PARAMETER :: SRNAME = 'MKL_DTPPACK'
    ! <<< Local scalars >>>
    ...
    CALL F77_MKL_TPPACK(O_UPLO,O_TRANS,N,AP,I,J,ROWS,COLS,A,LDA,O_INFO)
    ! <<< Error handler >>>
