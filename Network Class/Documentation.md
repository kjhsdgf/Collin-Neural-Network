...
#### Description:
This method reads in all the required parameters from the console, as entered by the user. Also, it asks the user to enter the name of the training_data file and expected_values file. 
...
#### Validation Check:
ReadInit() will be assigning the values to learning_rate, epochs, batch_size, layer_sizes, training_data_file and the expected_values_file. The value of the learning rate user enters has to be less than 1. 
