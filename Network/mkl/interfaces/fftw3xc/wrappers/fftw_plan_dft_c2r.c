...
/*
 *
 * fftw_plan_dft_c2r - FFTW3 wrapper to Intel(R) MKL.
 *
 ******************************************************************************
 */
...
fftw_plan
fftw_plan_dft_c2r(int rank, const int *n, fftw_complex *in, double *out,
                  unsigned flags)
{
    ...
    return fftw_plan_guru64_dft_c2r(rank, dims64, 0, NULL, in, out, flags);
}
