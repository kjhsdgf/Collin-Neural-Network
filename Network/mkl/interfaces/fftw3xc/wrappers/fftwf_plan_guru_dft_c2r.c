...
/*
 *
 * fftwf_plan_guru_dft_c2r - FFTW3 wrapper to Intel(R) MKL.
 *
 ******************************************************************************
 */
...
fftwf_plan
fftwf_plan_guru_dft_c2r(int rank, const fftwf_iodim *dims, int howmany_rank,
                       ...
                       float *out, unsigned flags)
{
    ...
    return fftwf_plan_guru64_dft_c2r(rank, dims64, howmany_rank, howmany_dims64,
                                    in, out, flags);
}
