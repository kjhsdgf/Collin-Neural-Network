...
/*
 *
 * fftw_plan_guru_split_dft - FFTW3 wrapper to Intel(R) MKL.
 *
 ******************************************************************************
 */
...
fftw_plan
fftw_plan_guru_split_dft(int rank, const fftw_iodim *dims, int howmany_rank,
                         const fftw_iodim *howmany_dims, double *ri,
                         double *ii, double *ro, double *io, unsigned flags)
{
    ...
    return fftw_plan_guru64_split_dft(rank, dims64, howmany_rank,
