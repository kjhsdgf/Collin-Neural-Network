...
/*
 *
 * fftw_plan_guru64_dft - FFTW wrapper to Intel(R) MKL.
 *
 ******************************************************************************
 */
...
fftw_plan
fftw_plan_guru64_dft(int rank, const fftw_iodim64 *dims, int howmany_rank,
                     ...
                     fftw_complex *out, int sign, unsigned flags)
{
    ...
    if (rank == 1)
        s = DftiCreateDescriptor(&mkl_plan->desc, DFTI_DOUBLE, DFTI_COMPLEX,
