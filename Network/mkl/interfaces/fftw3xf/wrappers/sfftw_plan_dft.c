...
/*
 *
 * sfftw_plan_dft - FFTW3 Fortran 77 wrapper to Intel(R) MKL.
 *
 ******************************************************************************
 */
...
void
sfftw_plan_dft(PLAN *p, INTEGER *rank, INTEGER *n, COMPLEX8 *in,
               COMPLEX8 *out, INTEGER *sign, INTEGER *flags)
{
    ...
    *(fftwf_plan *)p =
        fftwf_plan_guru64_dft(*rank, dims64, 0, NULL, in, out, *sign, *flags);
}
