...
/*
 *
 * sfftw_plan_guru_split_dft - FFTW3 Fortran 77 wrapper to Intel(R) MKL.
 *
 ******************************************************************************
 */
...
void
sfftw_plan_guru_split_dft(PLAN *p, INTEGER *rank, INTEGER *n, INTEGER *is,
                          INTEGER *os, INTEGER *howmany_rank,
                          INTEGER *howmany_n, INTEGER *howmany_is,
                          INTEGER *howmany_os, REAL4 *ri, REAL4 *ii, REAL4 *ro,
                          REAL4 *io, INTEGER *flags)
{
    ...
    *(fftwf_plan *)p =
        fftwf_plan_guru64_split_dft(*rank, dims64, *howmany_rank,
