...
/*
 *
 * sfftw_plan_guru_split_dft_r2c - FFTW3 Fortran 77 wrapper to Intel(R) MKL.
 *
 ******************************************************************************
 */
...
void
sfftw_plan_guru_split_dft_r2c(PLAN *p, INTEGER *rank, INTEGER *n, INTEGER *is,
                              INTEGER *os, INTEGER *howmany_rank,
                              INTEGER *howmany_n, INTEGER *howmany_is,
                              INTEGER *howmany_os, REAL4 *in, REAL4 *ro,
                              REAL4 *io, INTEGER *flags)
{
    ...
    *(fftwf_plan *)p =
        fftwf_plan_guru64_split_dft_r2c(*rank, dims64, *howmany_rank,
                                       howmany_dims64, in, ro, io, *flags);
}
