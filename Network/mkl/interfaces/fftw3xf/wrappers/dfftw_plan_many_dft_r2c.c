...
/*
 *
 * dfftw_plan_many_dft_r2c - FFTW3 Fortran 77 wrapper to Intel(R) MKL.
 *
 ******************************************************************************
 */
...
void
dfftw_plan_many_dft_r2c(PLAN *p, INTEGER *rank, INTEGER *n, INTEGER *howmany,
                        REAL8 *in, INTEGER *inembed, INTEGER *istride,
                        ...
                        INTEGER *ostride, INTEGER *odist, INTEGER *flags)
{
    ...
    dfftw_plan_guru_dft_r2c(p, rank, n, is, os, &one, howmany, idist, odist,
                            in, out, flags);
}
