...
/*
 *
 * dfftw_plan_guru_dft - FFTW3 Fortran 77 wrapper to Intel(R) MKL.
 *
 ******************************************************************************
 */
...
void
dfftw_plan_guru_dft(PLAN *p, INTEGER *rank, INTEGER *n, INTEGER *is,
                    ...
                    COMPLEX16 *out, INTEGER *sign, INTEGER *flags)
{
    ...
    *(fftw_plan *)p =
        fftw_plan_guru64_dft(*rank, dims64, *howmany_rank, howmany_dims64, in,
                             out, *sign, *flags);
}
