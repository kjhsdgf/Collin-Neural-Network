...
/*
 *
 * fftw_plan_guru_r2r - FFTW3 wrapper to Intel(R) MKL.
 *
 ******************************************************************************
 */
...
fftw_plan
fftw_plan_guru_r2r(int rank, const fftw_iodim *dims, int howmany_rank,
                   ...
                   const fftw_r2r_kind * kind, unsigned flags)
{
    ...
    return fftw_plan_guru64_r2r(rank, dims64, howmany_rank, howmany_dims64, in,
                                out, kind, flags);
}
