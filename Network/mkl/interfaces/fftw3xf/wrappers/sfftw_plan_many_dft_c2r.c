...
/*
 *
 * sfftw_plan_many_dft_c2r - FFTW3 Fortran 77 wrapper to Intel(R) MKL.
 *
 ******************************************************************************
 */
...
void
sfftw_plan_many_dft_c2r(PLAN *p, INTEGER *rank, INTEGER *n, INTEGER *howmany,
                        ...
                        INTEGER *ostride, INTEGER *odist, INTEGER *flags)
{
    ...
    sfftw_plan_guru_dft_c2r(p, rank, n, is, os, &one, howmany, idist, odist,
                            in, out, flags);
}
