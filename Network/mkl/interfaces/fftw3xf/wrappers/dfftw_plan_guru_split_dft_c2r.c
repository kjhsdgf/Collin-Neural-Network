...
/*
 *
 * dfftw_plan_guru_split_dft_c2r - FFTW3 Fortran 77 wrapper to Intel(R) MKL.
 *
 ******************************************************************************
 */
...
void
dfftw_plan_guru_split_dft_c2r(PLAN *p, INTEGER *rank, INTEGER *n, INTEGER *is,
                              INTEGER *os, INTEGER *howmany_rank,
                              INTEGER *howmany_n, INTEGER *howmany_is,
                              INTEGER *howmany_os, REAL8 *ri, REAL8 *ii,
                              REAL8 *out, INTEGER *flags)
{
    ...
    *(fftw_plan *)p =
        fftw_plan_guru64_split_dft_c2r(*rank, dims64, *howmany_rank,
